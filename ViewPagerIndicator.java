...
public class ViewPagerIndicator implements ViewPager.OnPageChangeListener{
    ...
    private int size;
    private int img1  = R.drawable.indexvf, img2 = R.drawable.indexvn;
    private int imgSize = 15;
    private List<ImageView> dotViewLists = new ArrayList<>();

    public ViewPagerIndicator(Context context,ViewPager viewPager,LinearLayout linearLayout,int size){
